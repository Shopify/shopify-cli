    ...
    module Types
      class ProductSubscriptionTest < MiniTest::Test
        def setup
          ...
          @product_subscription = Models::TypeDeclaration.new(type: ProductSubscription.new.identifier).load_type
        end
        ...
        def test_create_uses_standard_argo_create_implementation
          ...
          Features::Argo::Admin.any_instance
            .expects(:create)
            .with(directory_name, ProductSubscription.new.template_identifier, @context)
            .once
