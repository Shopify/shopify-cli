      ...
      class BaseTest < MiniTest::Test
        ...
        def test_config_returns_argo_renderer_package_name_version_if_it_exists_using_yarn
          ...
          with_stubbed_script(@context, Features::Argo::Base::SCRIPT_PATH) do
            stub_run_yarn_install_and_run_yarn_run_script_methods
            Argo::Base.any_instance.stubs(:run_list_command).returns(yarn_list_result)
            config = @dummy_argo.config(@context)
        ...
        def test_config_returns_argo_renderer_package_version_if_it_exists_using_npm
          ...
          with_stubbed_script(@context, Features::Argo::Base::SCRIPT_PATH) do
            ...
            Argo::Base.any_instance.stubs(:run_list_command).returns(npm_list_result)
        ...
        def test_config_aborts_with_error_if_found_version_is_invalid
          ...
          with_stubbed_script(@context, Argo::Base::SCRIPT_PATH) do
            ...
            Argo::Base.any_instance.stubs(:find_version_number).returns(invalid_version)
        ...
        def test_config_aborts_with_error_when_argo_renderer_package_name_not_found
          ...
          with_stubbed_script(@context, Features::Argo::Base::SCRIPT_PATH) do
            stub_run_yarn_install_and_run_yarn_run_script_methods
            Argo::Base.any_instance.stubs(:run_list_command).returns(result)
        ...
        def test_runs_yarn_install_and_yarn_run_script_if_the_package_manager_is_yarn
          with_stubbed_script(@context, Features::Argo::Base::SCRIPT_PATH) do
            ...
            Argo::Base.any_instance.expects(:run_yarn_install).returns(true).once
            Argo::Base.any_instance.expects(:run_yarn_run_script).returns(true).once
            Argo::Base.any_instance.stubs(:extract_argo_renderer_version).returns("0.0.1")
        ...
        def test_does_not_run_yarn_install_and_yarn_run_script_if_the_package_manager_is_npm
          with_stubbed_script(@context, Features::Argo::Base::SCRIPT_PATH) do
            ShopifyCli::JsSystem.any_instance.stubs(:package_manager).returns('npm')
            Argo::Base.any_instance.expects(:run_yarn_install).never
            Argo::Base.any_instance.expects(:run_yarn_run_script).never
            Argo::Base.any_instance.stubs(:extract_argo_renderer_version).returns("0.0.1")
        ...
        def test_raises_not_implemented_error_for_git_template_method
          assert_raises(NotImplementedError) { Argo::Base.new.git_template }
        end

        def test_raises_not_implemented_error_for_renderer_package_name_method
          assert_raises(NotImplementedError) { Argo::Base.new.renderer_package_name }
        end
        ...
        def stub_run_yarn_install_and_run_yarn_run_script_methods
          ShopifyCli::JsSystem.any_instance.stubs(:package_manager).returns('yarn')
          Argo::Base.any_instance.stubs(:run_yarn_install).returns(true)
          Argo::Base.any_instance.stubs(:run_yarn_run_script).returns(true)
        end
      end
    end
  end
