...
module Rails
  class GemTest < MiniTest::Test
    ...
    def test_install_does_not_install_if_installed
      ...
      Dir
        .expects(:glob)
        .with("#{@home}/.gem/ruby/#{RUBY_VERSION}/gems/mygem-*")
        .returns(["#{@home}/.gem/ruby/#{RUBY_VERSION}/gems/mygem-1.0.0"])
        .at_least_once
    ...
    def test_gem_home_returns_proper_path
      @context
        .expects(:capture2e)
        .with('gem', 'environment', 'home')
        .returns(["#{@home}/.gem/ruby/#{RUBY_VERSION}\n", mock(success?: true)])
    ...
    def test_gem_path_returns_proper_path
      ...
      @context
        .expects(:capture2e)
        .with('gem', 'environment', 'path')
        .returns(["#{tmpdir1}:#{tmpdir2}\n", mock(success?: true)])
