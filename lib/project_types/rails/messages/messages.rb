    ...
    MESSAGES = {
      rails: {
        ...
        create: {
          ...
          error: {
            ...
            node_version_failure:
              'Failed to get the current node version. Please make sure it is installed as ' \
                'per the instructions at https://nodejs.org/en.',
            yarn_required:
              'yarn is required to create a rails project. Download at ' \
        ...
        serve: {
          ...
          HELP
          error: { host_must_be_https: '{{red:HOST must be a HTTPS url.}}' },
          open_info: <<~MESSAGE,
        ...
        forms: {
          create: {
            error: { invalid_app_type: 'Invalid app type %s', invalid_db_type: 'Invalid database type %s' },
            app_name: 'App name',
            app_type: {
