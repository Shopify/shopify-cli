      ...
      script: {
        ...
        enable: {
          ...
          Turn on script in store.
            ...
            Options:
              {{command:--config_props='name1:value1, name2:value2'}} Optional. Define the configuration of your script by passing individual name and value pairs. If used with --config_file, then matching values in --config-props will override those set in the file.
