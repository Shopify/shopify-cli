  ...
  module Layers
    module Infrastructure
      class ScriptService
        ...
        def push(extension_point_type:, script_name:, script_content:, compiled_type:, api_key: nil, force: false)
        ...
        def enable(api_key:, shop_domain:, configuration:, extension_point_type:, title:)
          ...
          variables = { extensionPointName: extension_point_type.upcase, configuration: configuration, title: title }

          resp_hash =
            script_service_request(
        ...
        def disable(api_key:, shop_domain:, extension_point_type:)
          ...
          variables = { extensionPointName: extension_point_type.upcase }
