    ...
    module ErrorHandler
      ...
      def self.error_messages(e)
        ...
        when Errors::NoExistingStoresError
          {
            ...
            help_suggestion:
              ShopifyCli::Context.message('script.error.no_existing_stores_help', organization_id: e.organization_id)
          }
        ...
        when Layers::Domain::Errors::ScriptNotFoundError
          {
            cause_of_error:
              ShopifyCli::Context.message('script.error.script_not_found_cause', e.script_name, e.extension_point_type)
          }
        ...
        when Layers::Infrastructure::Errors::PackagesOutdatedError
          {
            cause_of_error:
              ShopifyCli::Context.message('script.error.packages_outdated_cause', e.outdated_packages.join(', ')),
            help_suggestion:
              ShopifyCli::Context.message(
