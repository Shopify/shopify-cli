  ...
  module Commands
    class System < ShopifyCli::Command
      ...
      def display_cli_constants(show_all_details)
        ...
        cli_constants_extra = %w[PROJECT_TYPES_DIR TEMP_DIR]
        cli_path_methods = %i[cache_dir tool_config_path log_file debug_log_file]
      ...
      def display_cli_ruby(_show_all_details)
        ...
        rbconfig_constants.each { |s| @ctx.puts('  ' + @ctx.message('core.system.rb_config', RbConfig::CONFIG[s], s)) }
      end
