...
class Liquid::DisabledError < Liquid::Error
end
...
module Liquid::StrainerFactory
  ...
  def create(context, filters = nil); end
...
class Liquid::Context
  ...
  def base_scope_depth=(arg0); end
  def check_overflow; end
  def clear_instance_assigns; end
  def disabled_tags=(arg0); end
  ...
  def initialize(environments = nil, outer_scope = nil, registers = nil, rethrow_errors = nil, resource_limits = nil, static_environments = nil); end
  ...
  def scopes; end
  def self.build(environments: nil, outer_scope: nil, registers: nil, rethrow_errors: nil, resource_limits: nil, static_environments: nil, &block); end
...
module Liquid::StandardFilters
  ...
  def default(input, default_value = nil, options = nil); end
...
class Liquid::Tokenizer
  ...
  def initialize(source, line_numbers = nil, line_number: nil, for_liquid_tag: nil); end
  def line_number; end
  def shift; end
  def tokenize; end
end
class Liquid::ParseContext
  ...
  def new_tokenizer(markup, start_line_number: nil, for_liquid_tag: nil); end
  def parse_expression(markup); end
  def partial; end
...
class Liquid::StaticRegisters
  ...
  def initialize(registers = nil); end
  def key?(key); end
  def static; end
end
